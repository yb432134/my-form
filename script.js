...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.testimonial-card, .service-card, .contact-card');
    ...
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            ...
            counters.forEach(counter => {
                const target = counter.textContent.includes('121') ? 121 : 
                             counter.textContent.includes('100') ? 100 : 5;
